...
public class WordCountNoCombiner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setMapperClass(WordCountNoCombiner.TokenizerMapper.class);
        //job.setCombinerClass(WordCountNoCombiner.IntSumReducer.class); // Combiner disabled
        job.setReducerClass(WordCountNoCombiner.IntSumReducer.class);
